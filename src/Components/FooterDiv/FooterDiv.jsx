            ...
            <div className='w-75 row gap-2 gy-4 py-5 justify-content-center align-items-start mt-4'>
                <div className='col-12 col-md-3'>
                    ...
                    <p className='text-white'>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim fugiat assumenda eius optio reprehenderit. Magnam distinctio quibusdam unde laudantium et voluptate ullam
                    </p>
                    <div className='d-flex gap-2'>
                        <div className='p-2 border d-flex justify-content-center align-items-center border-white text-white'>
                            <Facebook />
                        </div>
                        <div className='p-2 border d-flex justify-content-center align-items-center border-white text-white'>
                            <Twitter />
                ...
                <div className='col-12 col-md-2 d-flex flex-column gap-3'>
                    <h5 className='fw-bold text-white mb-4'><span className='border-bottom border-white pb-3'>Quick</span> Links</h5>
                    <a href="#" className='text-white text-decoration-none'><ChevronDoubleRight /> Extech About</a>
                    <a href="#" className='text-white text-decoration-none'><ChevronDoubleRight /> Our Services</a>
                    <a href="#" className='text-white text-decoration-none'><ChevronDoubleRight /> Our Blogs</a>
                    <a href="#" className='text-white text-decoration-none'><ChevronDoubleRight /> FAQ's</a>
                    <a href="#" className='text-white text-decoration-none'><ChevronDoubleRight /> Contact Us</a>
                </div>
                <div className='col-12 col-md-3 me-4 d-flex flex-column gap-3'>
                    <h5 className='fw-bold text-white mb-4'><span className='border-bottom border-white pb-3'>Recent</span> Posts</h5>
                    <div className='d-flex  align-items-center gap-2'>
                        <img src="src/assets/imgs/footerThumb1_1.webp" alt="" />
                        <div>
                            <p className='text-light sm-txt-footer'><Calendar />15th April,2024</p>
                            <h6 className='text-white sm-txt-footer'>Top 5 Most Famous Technology Trend in 2024</h6>
                        </div>
                    </div>
                    <div className='d-flex  align-items-center gap-2'>
                        <img src="src/assets/imgs/footerThumb1_2.webp" alt="" />
                        <div>
                            <p className='text-light sm-txt-footer'><Calendar />20th April,2024</p>
                            <h6 className='text-white sm-txt-footer'>The Surfing Man Will Blow Your Mind</h6>
                        </div>
                    </div>
                </div>
                <div className='col-12 col-md-3 d-flex flex-column gap-3 mb-4'>
                    <h5 className='fw-bold text-white'><span className='border-bottom border-white pb-3'>Contact</span> Us</h5>
                    <p className='text-white m-0'><Envelope /> tonydaoud2003@gmail.com</p>
                    <p className='text-white m-0'><Phone /> 0957889064</p>
                    <div className=' d-flex'>
                        <input className='p-2 rounded border-0' type="email" placeholder='Your Email' />
                        <Button className="d-flex justify-content-center align-items-center position-relative button-footer"> <ArrowRight /> </Button>
                    </div>
                    <div className='d-flex gap-2 align-items-center'>
                        <input type="checkbox" />
                        <p className='text-white m-0'>i agree to the <span className='text-decoration-underline'>Privacy Policy</span></p>
                    </div>
                </div>
            </div>
            <div className='w-100 bg-main-blue d-flex justify-content-center py-2'>
                <div className='w-75 d-flex justify-content-between align-items-center footer-bot'>
                    <p className='m-0 text-white'>&copy;All CopyRight 2024 by Extech</p>
                    <div className='d-flex gap-4'>
                        <span className='m-0 text-white'>Terms and conditions</span>
                        <span className='m-0 text-white'>privacy policy</span>
                    </div>
                </div>
            </div>
        </>
